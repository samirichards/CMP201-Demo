...
namespace CMP201Demo {
	...
	private: System::Windows::Forms::TextBox^ txt_needle;
	private: System::Windows::Forms::ComboBox^ Cmb_SearchSelect;
...
#pragma endregion
private: System::Void Cmb_SearchSelect_SelectionChangeCommitted(System::Object^ sender, System::EventArgs^ e) {
...
private: System::Void btn_search_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	{
		*indexes = bmSearch(&msclr::interop::marshal_as<std::string>(rTxt_haystack->Text), &msclr::interop::marshal_as<std::string>(txt_needle->Text));
	...
	{
		*indexes = rkSearch(&msclr::interop::marshal_as<std::string>(rTxt_haystack->Text), &msclr::interop::marshal_as<std::string>(txt_needle->Text));
		txt_output->Text = "Using " + Cmb_SearchSelect->SelectedItem + " Search Algorithm\n";
		if (indexes->size())
		{
			txt_output->Text += "Found " + txt_needle->Text + " at the following indexes:\n";
